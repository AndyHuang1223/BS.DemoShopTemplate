    ...
    public partial class initDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationReferences", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specifications_SpecificationReferences_SpecificationReferenceId",
                        column: x => x.SpecificationReferenceId,
                        principalTable: "SpecificationReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discount = table.Column<decimal>(type: "decimal(5,0)", precision: 5, scale: 0, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specifications_SpecificationReferenceId",
                table: "Specifications",
                column: "SpecificationReferenceId");
        }
